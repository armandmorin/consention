...
const GlobalAnalytics: React.FC = () => {
  ...
  const overviewStats = [
    { name: 'Total Impressions', value: '1.2M', change: '+12%', trend: 'up' },
    { name: 'Consent Rate', value: '87%', change: '+5%', trend: 'up' },
    { name: 'Rejection Rate', value: '8%', change: '-2%', trend: 'down' },
    { name: 'Customized Consents', value: '5%', change: '+1%', trend: 'up' },
  ];

  const topDomains = [
    { domain: 'acme.com', impressions: 245000, consentRate: 92 },
    { domain: 'globex.com', impressions: 187000, consentRate: 88 },
    { domain: 'initech.com', impressions: 156000, consentRate: 85 },
    { domain: 'umbrella.com', impressions: 134000, consentRate: 81 },
    { domain: 'stark.com', impressions: 98000, consentRate: 79 },
  ];
      ...
      <div className="grid grid-cols-1 gap-6">
        ...
        <div className="bg-white shadow rounded-lg">
          <div className="px-4 py-5 sm:px-6">
            <h3 className="text-lg leading-6 font-medium text-gray-900">Top Performing Domains</h3>
            <p className="mt-1 max-w-2xl text-sm text-gray-500">Domains with highest consent rates and impressions.</p>
          </div>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="w-full bg-gray-200 rounded-full h-2.5">
                          <div 
                            ...
                            style={{ width: `${domain.consentRate}%` }}
                          ></div>
                        </div>
                      </td>
                    </tr>
